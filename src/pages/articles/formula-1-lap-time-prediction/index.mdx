...
![Data Collection and Preprocessing](/articles/formula-1-time-prediction/data-collection.png)
...
![Feature Engineering](/articles/formula-1-time-prediction/feature-engineering.png)
...
![Predicted vs Actual Lap Times](/articles/formula-1-time-prediction/predicted_data.png)
...
For more details, check out the [Kaggle notebook](https://www.kaggle.com/code/lucasdraichi/hamilton-lap-time-prediction) I created for this project.
