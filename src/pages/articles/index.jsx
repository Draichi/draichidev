...
export default function ArticlesIndex({ articles }) {
  const headline = 'Exploring the Intersection of Technology and Innovation.'
  const intro =
    'Dive into my comprehensive articles on software development, AI, machine learning, and more, showcasing my journey and insights in the tech world.'
